...
public class GetPhoneListRspAllOf {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<Phone> data = null;


  public GetPhoneListRspAllOf data(List<Phone> data) {
    
    this.data = data;
    return this;
  }

  public GetPhoneListRspAllOf addDataItem(Phone dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetPhoneListRspAllOf getPhoneListRspAllOf = (GetPhoneListRspAllOf) o;
    return Objects.equals(this.data, getPhoneListRspAllOf.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPhoneListRspAllOf {\n");
