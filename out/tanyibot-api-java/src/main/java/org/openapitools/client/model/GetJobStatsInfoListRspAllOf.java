...
public class GetJobStatsInfoListRspAllOf {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<GetJobStatsInfoListRspAllOfData> data = null;


  public GetJobStatsInfoListRspAllOf data(List<GetJobStatsInfoListRspAllOfData> data) {
    
    this.data = data;
    return this;
  }

  public GetJobStatsInfoListRspAllOf addDataItem(GetJobStatsInfoListRspAllOfData dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetJobStatsInfoListRspAllOf getJobStatsInfoListRspAllOf = (GetJobStatsInfoListRspAllOf) o;
    return Objects.equals(this.data, getJobStatsInfoListRspAllOf.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetJobStatsInfoListRspAllOf {\n");
