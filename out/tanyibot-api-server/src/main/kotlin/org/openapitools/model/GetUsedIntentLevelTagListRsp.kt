...
import org.openapitools.model.GetUsedIntentLevelTagListRspAllOf
 ...
 * @param data 
 */
data class GetUsedIntentLevelTagListRsp(
    ...
    @field:JsonProperty("data") val data: kotlin.collections.List<IntentLevelTag>? = null
) {
