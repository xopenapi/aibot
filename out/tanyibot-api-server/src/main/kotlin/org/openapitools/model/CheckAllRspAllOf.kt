...
data class CheckAllRspAllOf(
    ...
    @field:JsonProperty("status") val status: CheckAllRspAllOf.Status? = null,

    @field:JsonProperty("hangUpType") val hangUpType: CheckAllRspAllOf.HangUpType? = null,
