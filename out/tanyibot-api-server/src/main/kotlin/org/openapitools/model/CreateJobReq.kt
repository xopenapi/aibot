...
data class CreateJobReq(
    ...
    @field:JsonProperty("jobPhoneNumberIdList") val jobPhoneNumberIdList: kotlin.collections.List<kotlin.Int>? = null,

    @field:JsonProperty("transferPhoneNumber") val transferPhoneNumber: kotlin.collections.List<kotlin.String>? = null,

    @field:JsonProperty("robotCallJob") val robotCallJob: kotlin.Any? = null
) {
