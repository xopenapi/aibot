...
data class UpdatePolicyGroupReq(
    ...
    @field:JsonProperty("callPolicyGroupId") val callPolicyGroupId: kotlin.Long? = null,

    @field:JsonProperty("name") val name: kotlin.String? = null,

    @field:JsonProperty("remark") val remark: kotlin.String? = null,

    @field:JsonProperty("dispatchType") val dispatchType: UpdatePolicyGroupReq.DispatchType? = null
) {
