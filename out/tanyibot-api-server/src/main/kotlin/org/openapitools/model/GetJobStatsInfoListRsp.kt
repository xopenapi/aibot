...
import org.openapitools.model.GetJobStatsInfoListRspAllOf
import org.openapitools.model.GetJobStatsInfoListRspAllOfData
 ...
 * @param data 
 */
data class GetJobStatsInfoListRsp(
    ...
    @field:JsonProperty("data") val data: kotlin.collections.List<GetJobStatsInfoListRspAllOfData>? = null
) {
